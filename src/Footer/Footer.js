            ...
            <LinkDiv>
                ...
                <Span padding='0px 10px'>
                    <Links href='https://www.linkedin.com/company/sksi-associates-llp/' color={COLOR.GRAY} underline='none'>
                        <FontIcon padding='0px 10px' font='20px' align='center' color={COLOR.BLUE} name={['fab', 'linkedin-in']}/>
                        LinkedIn
                    </Links>
                </Span>
                <Span padding='0px 10px'>
                    <Links href={'#contactus'} color={COLOR.GRAY} underline='none'>
                        <FontIcon padding='0px 10px' font='20px' align='center' color={COLOR.BLUE} name='phone-alt'/>
                        Contact Us
                    </Links>
                </Span>
            </LinkDiv>
